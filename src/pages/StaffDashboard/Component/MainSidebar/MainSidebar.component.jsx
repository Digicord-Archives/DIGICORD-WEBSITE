...
import { FaFileMedical, FaUserEdit } from "react-icons/fa";
import {
  IoLogOut,
  IoSettingsSharp,
  IoFlaskSharp,
...
const MainSidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div ref={sidebarRef} className="staffMainSidebarWrapper">
      <div className="mainSidebar">
        ...
        <nav className="navigation">
          {/* <Link to="/staff/appointment" className="navigation__items">
            <span>
              <FaBookMedical />
            </span>
            <p>View Patient Medical Records</p>
          </Link> */}
          <Link to="/staff/records" className="navigation__items">
            <span>
              <FaFileMedical />
            </span>
            <p>Manage Patient Appointment</p>
          </Link>
          <Link to="/staff/history" className="navigation__items">
            <span>
              <IoFlaskSharp />
            </span>
            <p>Laboratory</p>
          </Link>
          <Link to="/staff/notification" className="navigation__items">
            <span>
              <IoMdNotifications />
            </span>
            <p>Notifications</p>
          </Link>
          <Link to="/staff/settings" className="navigation__items">
            <span>
              <CgPill />
            </span>
            <p>Pharmarcy</p>
          ...
          <Link to="/staff/edit-profile" className="navigation__items">
            <span>
              <FaUserEdit />
            </span>
            <p>Edit Profile</p>
